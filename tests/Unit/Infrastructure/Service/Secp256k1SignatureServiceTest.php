...
final class Secp256k1SignatureServiceTest extends TestCase
{
    public function testCreateYieldsFfiServiceWhenLibraryAvailable(): void
    {
        $service = Secp256k1SignatureService::create();
    ...
    private function assertVerifyRejectsTamperedMessage(Secp256k1SignatureService $service): void
    {
        $privateKey = PrivateKey::generate();
        $publicKey = $service->derivePublicKey($privateKey);
        $message = random_bytes(32);
