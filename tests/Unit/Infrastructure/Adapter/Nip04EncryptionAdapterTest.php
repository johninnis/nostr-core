...
use Innis\Nostr\Core\Infrastructure\Adapter\Nip04EncryptionAdapter;
use PHPUnit\Framework\TestCase;

final class Nip04EncryptionAdapterTest extends TestCase
{
    public function testEncryptAndDecryptRoundTripsAsciiPlaintext(): void
    {
        $adapter = new Nip04EncryptionAdapter();
    ...
    {
        $adapter = new Nip04EncryptionAdapter(new class implements RandomBytesGeneratorInterface {
