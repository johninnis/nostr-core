...
final class Secp256k1Ecdh implements EcdhServiceInterface
{
    ...
    // Deliberate: deployment introspection only, and deliberately absent from EcdhServiceInterface so no domain or application code can branch on the backend — see ADR-0057
